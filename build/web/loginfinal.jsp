    ...
    <div class="container">
        ...
        <div class="right">
          <div class="form">
            ...
            <form class="form-inside" action="LoginServlet" method ="post">
              <div class="up"></div>
              <div class="label">
              ...
              <div class="up"></div>
              <div class="box">
              <input type="submit" name="" id="" value="Login" /></div>
              ...
              <div class="not-member">
                <span
                  >Not a Member?
                  <a href="registrationfinal.jsp" class="singup_option">Register</a></span
                >
              </div>
            </form>
          </div>
